            ...
            <div className="container-fluid mission-bg">
                <div className="container-xl">
                            ...
                            <div className='missionbox'>
                                <div className='mission-inner'>
                                    ...
                                    <div className="col text-center py-4">
                                        <img src={mission} alt="" width={50} loading='lazy' />
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-sm-6 p-md-4 mb-3">
                            <div className='missionbox'>
                                <div className='mission-inner'>
                                    ...
                                    <div className="col text-center py-4">
                                        <img src={values} alt="" width={50} loading='lazy' />
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-sm-6 p-md-4 mb-3">
                            <div className='missionbox'>
                                <div className='mission-inner'>
                                    ...
                                    <div className="col text-center py-4">
                                        <img src={vision} alt="" width={50} loading='lazy' />
                                    </div>
                                </div>
                    ...
                    <div className="row people-love">
                        ...
                        <h3>Love</h3>
                        <div className="col text-center py-4">
                            <img src={heart} alt="" width={50} loading='lazy' />
                        </div>
                    ...
                    <div className='row text-center justify-content-around'>
                        <div className="col-lg-4 col-md-4 col-sm-6">
                            <div className='mb-3'>
                                <img src={girl1} alt="" className='img-fluid' loading='lazy' />
                            </div>
                        </div>
                         
                        <div className="col-lg-4 col-md-4 col-sm-6 girlbox-margin">
                            <div className='mb-3'>
                                <img src={girl2} alt="" className='img-fluid' loading='lazy' />
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-4 col-sm-6">
                            <div className='mb-3'>
                                <img src={girl3} alt="" className='img-fluid' loading='lazy' />
                            </div>
                        </div>
                    </div>
                </div>
