...
import upperQuote from '../../Images/testimonial-bg-1.png'
import lowerQuote from '../../Images/testimonial-bg-2.png'
    ...
    return (
        <div className="container-fluid success-stories-main">
            <div className="container-xl">
                ...
                <div className=" testimonial-block py-5">
